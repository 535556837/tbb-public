$(function() {
	...
	var pubwinusers_html =
		'<div class="modal inmodal fade" id="pubwinusers_Modal" tabindex="-1" '+
				'role="dialog" aria-hidden="true"  data-remote="jsp/util/pubwinUsers.html">'+
			'<div class="modal-dialog " style="width:80%;">'+
				'<div class="modal-content animated bounceInRight"> '+
				'</div>'+
		   '</div>'+
