...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	/**
	 * @Title: writeMultipartFile 
	 * @Description: Spring MultipartFile 文件写入
	 * @param file
	 * @param descFileName 目标文件
	 * @return
	 * @author 黄胜  hs  
	 * @date 2016年7月13日 上午9:33:16 
	 * @修改信息 (修改人修改内容及修改时间)
	 */
...
//                out.close();
	...
	public static String fileRead(String filename) throws Exception {
        ...
        InputStreamReader reader = new InputStreamReader(new FileInputStream(file),"utf-8");//定义一个fileReader对象，用来初始化BufferedReader
