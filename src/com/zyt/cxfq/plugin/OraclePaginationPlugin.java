...
public class OraclePaginationPlugin extends PluginAdapter {
	 ...
	 */
	public static final String pageClassPath = "com.common.BootPage";
	...
	public boolean sqlMapDocumentGenerated(Document document,
		...
		paginationPrefixElement.addAttribute(new Attribute("id",
				"OracleDialectPrefix"));
		paginationPrefixElement.addElement(new TextElement(
		...
		paginationSuffixElement.addAttribute(new Attribute("id",
				"OracleDialectSuffix"));
		paginationSuffixElement.addElement(new TextElement(
				"<!--WARNING - @mbggenerated This element is automatically generated by MyBatis Generator, do not modify.    -->"));
	...
	public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
		...
		element.getElements().add(0,new TextElement(
				"<!--WARNING - @mbggenerated This element is automatically generated by MyBatis Generator, do not modify.    -->"));
		...
		pageEnd.addAttribute(new Attribute("refid",
				"OracleDialectSuffix"));
		element.getElements().add(pageEnd);
