package com.zyt.cxfq.service.shrio;
...
import com.zyt.cxfq.common.util.SerializeUtil;
import com.zyt.cxfq.service.redis.JedisManager;
/**
 * 
 * 开发公司：sojson.com<br/>
 * 版权：sojson.com<br/>
...
public class JedisShiroCache<K, V> implements Cache<K, V> {
    ...
    public V put(K key, V value) throws CacheException {
        ...
        try {
        	...
        	e.printStackTrace();
        	System.out.println("put cache throw exception");
        }
        return previos;
    }
